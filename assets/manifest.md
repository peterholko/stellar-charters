# Stellar Charters Asset Manifest

Generated from `graphics-prompts.md`.

| Asset | Filename | Aspect | Transparent |
| --- | --- | --- | --- |
| Game Logo / Wordmark (16:9) | `assets/A-branding-and-key-art/game-logo-wordmark-16x9.png` | 16:9 | yes |
| Game Logo / Wordmark (square) | `assets/A-branding-and-key-art/game-logo-wordmark-square.png` | 1:1 | yes |
| Title / Key Art Splash | `assets/A-branding-and-key-art/title-key-art-splash.png` | 16:9 | no |
| Corporation / Faction Emblem Set | `assets/A-branding-and-key-art/corporation-faction-emblem-set.png` | 1:1 grid of 6 | yes |
| Wormhole Authority Seal | `assets/A-branding-and-key-art/wormhole-authority-seal.png` | 1:1 | yes |
| Survey Skiff (Range 1) | `assets/B-ships-and-convoys/survey-skiff.png` | 1:1 | yes |
| Cargo Freighter (Range 1-2) | `assets/B-ships-and-convoys/cargo-freighter.png` | 3:2 | yes |
| Escort Cutter / Frontier Escort | `assets/B-ships-and-convoys/escort-cutter.png` | 3:2 | yes |
| Corsair / Raider Corvette (Privateer) | `assets/B-ships-and-convoys/corsair-raider-corvette.png` | 3:2 | yes |
...
| Warp Route / Warp Tunnel Lane (unstable) | `assets/C-map-and-environments/warp-route-unstable.png` | 16:9 | yes |
| The Wormhole Hub | `assets/C-map-and-environments/wormhole-hub.png` | 16:9 | no |
| Colony Stage Set (Outpost) | `assets/C-map-and-environments/colony-stage-outpost.png` | 16:9 | no |
| Colony Stage Set (Settlement) | `assets/C-map-and-environments/colony-stage-settlement.png` | 16:9 | no |
| Colony Stage Set (Colony) | `assets/C-map-and-environments/colony-stage-colony.png` | 16:9 | no |
| Colony Stage Set (City) | `assets/C-map-and-environments/colony-stage-city.png` | 16:9 | no |
| Colony Stage Set (Metropolis) | `assets/C-map-and-environments/colony-stage-metropolis.png` | 16:9 | no |
| Garden World | `assets/C-map-and-environments/garden-world.png` | 1:1 | no |
| Mining / Extraction System | `assets/C-map-and-environments/mining-extraction-system.png` | 16:9 | no |
| Trade Depot / Route Infrastructure | `assets/C-map-and-environments/trade-depot-route-infrastructure.png` | 16:9 | yes |
